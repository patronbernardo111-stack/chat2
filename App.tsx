        ...
        if (selectedChat) {
          ...
          return (
            <div style={{ position: 'fixed', inset: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden', zIndex: 1001 }} onClick={() => { if(showChatMenu) setShowChatMenu(false); }}>
              ...
              {/* Header conversacin */}
              <div style={{ position: 'sticky', top: 0, left: 0, right: 0, zIndex: 10, display: 'flex', alignItems: 'center', paddingTop: 'max(14px, env(safe-area-inset-top))', paddingLeft: '4px', paddingRight: '8px', paddingBottom: '4px', background: '#ffffff', borderBottom: '1px solid rgba(0,0,0,0.08)', flexShrink: 0 }}>
                <button
